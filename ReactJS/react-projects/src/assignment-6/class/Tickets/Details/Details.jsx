        ...
        <>
            {
                ticketLoading ? <div style={{textAlign: 'center'}}>Loading....</div> :
                    tickets.filter((ticket) => {
                        ...
                        .map((ticket) => (
                            <tr key={ticket.id}>
                                <TableColumn name={ticket.name} time={ticket.timeStatus} imageDisplayStatus="" imageSrc={ticket.imgSrc} ticketid={ticket.nodeName} />
                                ...
                                <td>
                                    <AiOutlineDelete style={{cursor: 'pointer'}} onClick={() => deleteTicket(ticket.nodeName)} />
                                </td>
                            </tr>
                        ))
            }
